# ruff: noqa: I001,E402
"""Parsing an editable CSV and save its markdown and ProcessedDocument output (generated by vscode and debugged a little)."""
...
ensure_openrag_source_path() #really useful for running this script from the examples directory, without installing OpenRAG
